...
function UploadingAnimation({ progress }) {
  return (
    <div className="relative w-16 h-16">
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <div
                        className={cn(
                            "relative mx-auto w-full overflow-hidden rounded-lg border border-slate-200 border-gray-100 dark:border-white/[0.08] bg-white dark:bg-black/50 dark:border-slate-800",
                        ...
                        <AnimatePresence>
                            {error && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -10 }}
                                    className="absolute bottom-4 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-red-500/10 border border-slate-200 border-red-500/20 rounded-lg dark:border-slate-800">
